...
The current frontend version has been modified to fit the server requirements for HTTP requests and Cookie authentication, therefore, in order to run it locally through localhost, please visit https://github.com/hfbgk321/reinvest_fullstack
